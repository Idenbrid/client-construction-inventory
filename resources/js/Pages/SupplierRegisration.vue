                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 master-form-col">
                                <div class="master-registration-left-content">
                                    <div class="master-registration-input-content">
                                        <span>発注先名称</span>
                                        <input class="master-reg-input" type="text" name="発注先名称" id="発注先名称" v-model="record.supplier_name"
                                            placeholder="テキスト">
                                    </div>
                                    <small>
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in list" :key="index">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn" @click="editSupplier(item)"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                                </div>
                                                </td>
                                            </tr>
                                        </tbody>
