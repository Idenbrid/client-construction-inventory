                            ...
                            <div class="col-md-12 p-0">
                                ...
                                <ul class="switch-div">
                                    <li class="form-fields">
                                        ...
                                        <input disabled type="text" :value="order.site_name = order.job_number.site_name"  id="fname" name="fname" placeholder="テキスト" class="form-control input-border">
                                        <small>
                                ...
                                <ul class="switch-div">
                                    <li class="form-fields ">
                                        ...
                                        <div class="date">
                                            <input type="date" v-model="order.order_date" id="date" name="datebirth" class="form-control input-border">
                                            <small>
                                ...
                                <!-- <ul class="switch-div">
                                    <li class="form-fields">
                                        ...
                                        <select class="input-border" v-model="order.supplier_id" name="cars" id="cars">
                                            <option v-for="supp in suppliers" :value="supp.id">{{supp.supplier_name}}</option>
                                        </select>
                                        <small>
                                            <span v-if="errors.supplier_id != null" class="text-danger float-left">
                                ...
                                <ul class="switch-div">
                                    <li class="form-fields">
                                        ...
                                        <input type="text" id="fname" v-model="order.amount" name="fname" placeholder="テキスト" class="form-control input-border">
                                        <small>
