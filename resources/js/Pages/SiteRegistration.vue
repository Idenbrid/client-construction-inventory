                    ...
                    <div class="master-reg-row">
                        <div class="master-reg-form">
                            ...
                            <div class="account-input-content">
                                ...
                                <div class="account-reg-input">
                                    <input class="master-reg-input" v-model="site.site_name" type="text" name="現場名"
                                        id="現場名" placeholder="テキスト">
                                    <small>
                                        ...
                                        <tr class="f-12-regular" v-for="(site, index) in list" :key="index">
                                            ...
                                            <td>
                                                <div class="btn-grouped">
                                                    <a class="btn" @click="deleteSite(site.id)"><i
                                                            class="fa-solid fa-trash-can delete-icon"></i> </a>
                                                    <a class="btn" @click="editSite(site)"><i
